...
namespace courseWork2.catDataSetTableAdapters {
    ...
    public partial class categoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT       DISTINCT  category.category_id, category.category_name
FROM            category INNER JOIN
                         cat_subcategory ON cat_subcategory.category_id = category.category_id INNER JOIN
                         category_gender ON category_gender.cat_subcat_id = cat_subcategory.cat_subcat_id INNER JOIN 
gender ON category_gender.gender_id = gender.gender_id
WHERE        (gender.gender_name = @gender_name)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@gender_name", global::System.Data.SqlDbType.NVarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "gender_name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(catDataSet.categoryDataTable dataTable) {
        ...
        public virtual catDataSet.categoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            catDataSet.categoryDataTable dataTable = new catDataSet.categoryDataTable();
        ...
        public virtual int FillBy(catDataSet.categoryDataTable dataTable, string gender_name) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((gender_name == null)) {
                throw new global::System.ArgumentNullException("gender_name");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(gender_name));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(catDataSet.categoryDataTable dataTable) {
